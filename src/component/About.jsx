      ...
      <div className="px-5 md:px-24 lg:px-0 mx-auto w-full max-w-[1230px]">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-14">
          <div className="flex flex-col justify-between items-start gap-5 md:gap-[30px]">
            <h3 className="text-[24px] md:text-[52px] font-[800]">
              HAPPYHAMSTER20?
            </h3>
            <p className="text-[12px] md:text-[20px] Montserrat font-light text-justify">
            ...
            <button className="text-[12px] md:text-[18px] font-normal button_background px-8 md:px-[50px] py-3 md:py-5 rounded-md md:border-[2px] border-[#FFEBA0] mx-auto md:mx-0">
              Get the Whitepaper
            </button>
          </div>
          <div className="relative">
            <img
              src={aboutImg}
              alt=""
              className="relative !w-full max-w-[450px] h-[320px] md:max-h-[550px] z-30"
            />
          </div>
        </div>
      </div>
